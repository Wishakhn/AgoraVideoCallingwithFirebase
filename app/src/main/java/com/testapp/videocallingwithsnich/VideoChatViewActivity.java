...
//                    mLogView.logI("User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    private void initUI() {
        ...
        if (gtent != null) {
            setcallername = gtent.getStringExtra("uname");
        }
...
//        mLogView = findViewById(R.id.log_recycler_view);
    ...
    private void showSampleLogs() {
        System.out.println("Welcome to Agora 1v1 video call");
        System.out.println("You will see custom logs here");
        System.out.println("You can also use this to show errors");
